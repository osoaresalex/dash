...
const WeatherSnap = () => {
  const [temperature] = React.useState(N.rand(28, 32));
  return React.createElement(
    "span",
    { className: "weather" },
...
const Restaurants = () => {
  const getRestaurants = () => {
    return [
      {
        desc: "Se sentindo com fome, Alex?",
        id: 1,
        image:
      ...
      },
      {
        ...
        title: "E é serio! Não vá. ",
      },
      {
        desc: "Isso já está ficando para baixo",
        id: 3,
        image:
        ...
        title: "Suas leituras dizem que está enjoado",
      },
      {
        desc: "Não precisa de churrasco! Mas sei que vai querer isso.",
        id: 4,
        image:
...
const Movies = () => {
  const getMovies = () => {
    return [
      {
        desc: "Um conto de algumas pessoas cuidando de uma grande parte do espaço.",
        id: 1,
        ...
        title: "Protetores da Via Láctea",
      },
      {
        desc: "Algumas pessoas saem de seus buracos para atrapalhar algumas coisas.",
        id: 2,
        ...
        title: "Pessoas do Buraco",
      },
      {
        desc: "Um garoto com um amassado na cabeça tenta impedir um bandido. Ele é muito, quero dizer ruim em ganhar.",
        id: 3,
        ...
        title: "Pote de Cabelo",
      },
      {
        desc: "Uma longa história de algumas pessoas brigando por algum espaço. Porque não é o suficiente.",
        id: 4,
  ...
  return React.createElement(
    MenuSection,
    {
      ...
      id: "movies-section",
      scrollable: true,
      title: "Hora da pipoca! Desculpe à descrição, ainda estou aprendendo!",
    },
    getMovies()
  );
};
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          {
            ...
            href: "https://www.youtube.com/c/osoaresalex",
            target: "_blank",
          },
          React.createElement("i", { className: "fa-brands fa-youtube" }),
          React.createElement("span", null, "OsoaresAlex")
        ),
